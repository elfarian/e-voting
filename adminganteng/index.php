...
<?php
	...
	if($p == "") include 'Page/dashboard.php';
		...
		if($p == "calon") include 'Page/calon.php';
			...
			if($p == "del_tak_sah") include 'Page/del_tak_sah.php';
	else
		// Data Pemilih
		...
		option =
		{
		    ...
		    xAxis: [
		        { type: 'category', show: true,
		            <?php $hasil = laporan(); $hasil_tak_sah = laporan_tak_sah();?>
		            data: [ <?php foreach($hasil as $row): echo "'".$row['nama']."',"; endforeach; ?>'Suara Tak Sah','belum memilih' ]
		        }
		    ],
		    ...
		    series: [
		        { name: '', type: 'bar',
		            ...
		            data: [ <?php foreach($hasil as $row): echo "'".$row['hasil']."',"; endforeach; foreach($hasil_tak_sah as $row): echo "'".$row['jumlah_tak_sah']."',"; endforeach; echo "'".$belum."'";?>],
		        }
		    ]
		};
