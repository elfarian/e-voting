<title>Edit Calon Ketua Hima Telkom PENS 2020 | Suksesi Hima Telkom PENS 2020</title>	
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Edit Calon Ketua Hima Telkom PENS 2020</h2>
			</div>
		</div><!--/.row-->
<?php 
						...
						<form action="" method="post" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										<label for="organisasi">NRP</label>
										<input name="organisasi" type="text" class="form-control" value="<?=$_organisasi?>" placeholder="Nrp">
									</div>
									<div class="form-group">
