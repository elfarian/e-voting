...
$no    = 1
?>
<title>Calon Ketua Hima Telkom PENS 2020 | Suksesi Hima Telkom PENS 2020</title>	
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<a href="?p=del_tak_sah" class="btn btn-xs btn-warning">Hapus Suara Tak Sah</a>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Calon Ketua Hima Telkom PENS 2020</h2>
			</div>
		</div><!--/.row-->
