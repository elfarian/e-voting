...
<body>
	<center>
		<div class="panel panel-default">
			...
			<div class="panel-heading">Admin Pemilihan Ketua OSIS</div>
...
?>
				...
				<form method="post">
					<div class="form-group">
						<input type="text" name="username" autocomplete="off" class="form-control" placeholder="Username" autofocus="">
					</div>
					<div class="form-group">
